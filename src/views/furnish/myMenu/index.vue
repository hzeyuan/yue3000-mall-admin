    ...
    <el-card>
      <div class="flex-box">
        <div class="table-box" style="">
          ...
          >
            ...
            <el-table-column label="操作" width="200" align="center">
              <template slot-scope="scope">
                <el-button size="small" @click="ontoUpdate(scope.row.id)">
                  修改
                </el-button>
        ...
        <div ref="phone" class="phone">
          <div v-if="iframeShow" class="model-content">
            <iframe
              frameborder="no"
              src="http://localhost:8080/mobile/pages/user/user"
...
<script>
  import { getAppMy, deleteAppMyById } from '@/api/furnish/myMenu'
  ...
  export default {
    ...
    methods: {
      ...
      ontoAdd() {
        this.$router.push({
          path: '/furnish/add-my-menu',
        })
      },
      // 点击跳转到修改页面
      ontoUpdate(id) {
        this.$router.push({
          path: `/furnish/update-my-menu${id}`,
        })
      },
      // 点击删除某项
      onDelete(id) {
